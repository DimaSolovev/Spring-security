package solovei.sprinsequritydemo.rest;
...
import solovei.sprinsequritydemo.security.JwtTokenProvider;
...
public class AuthenticationRestControllerV1 {
    ...
    public ResponseEntity<?> authenticate(@RequestBody AuthenticationRequestDTO request) {
        try {
            ...
            User user = userRepository.findByEmail(request.getEmail()).orElseThrow(() -> new UsernameNotFoundException("User doesnt exist"));
